...
#pragma region Getters
    ...
    // Andrew Knopf (andrew.knopf@digipen.edu)
    // Boid getters
...
#pragma region Setters
    ...
    void set_acceleration(const Vec3& acc);
    void set_target(const Vec3& targ);
...
private:
    ...
    // Andy Knopf (andrew.knopf@digipen.edu)
    // Boid variables
    Vec3 velocity;
    Vec3 acceleration;
    Vec3 target; // Should be center of mass of other agnets
