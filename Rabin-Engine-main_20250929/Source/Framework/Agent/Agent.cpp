...
const Vec3& Agent::get_velocity() const
{
  return velocity;
}

const Vec3& Agent::get_acceleration() const
{
  return acceleration;
}

const Vec3& Agent::get_target() const
{
  return target;
}
...
void Agent::set_velocity(const Vec3& vel)
{
  velocity = vel;
  isDirty = true;
}

void Agent::set_acceleration(const Vec3& acc)
{
  acceleration = acc;
  isDirty = true;
}

void Agent::set_target(const Vec3& targ)
{
  target = targ;
  isDirty = true;
}
