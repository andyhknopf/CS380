...
void ProjectTwo::build_ui()
{
    ...
    Callback nextBigMapCB = std::bind(&Terrain::goto_big_next_map, terrain.get());
    auto bigMapButton = ui->create_button(UIAnchor::BOTTOM, mapButton,
        10, nextBigMapCB, L"Next Big Map");
    ...
    auto methodButton = ui->create_dynamic_button(UIAnchor::BOTTOM, bigMapButton,
    ...
    Callback bigMapCB = std::bind(&PathTester::execute_big_map_test, &tester);
    auto bigMapTestButton = ui->create_button(UIAnchor::BOTTOM, speedTestButton, 10,
        bigMapCB, L"Run BigMap Test");

    //Callback bothMapCB = std::bind(&PathTester::execute_all_speed_test, &tester);
    //auto bothMapCBTestButton = ui->create_button(UIAnchor::BOTTOM, bigMapTestButton, 10,
    //    bothMapCB, L"Compare Test");
